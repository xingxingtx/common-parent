...
import com.hoperun.hbcc.common.ca.CAUtils;
import com.hoperun.hbcc.common.ca.RSAUtils;
import com.hoperun.hbcc.common.utils.StringUtil;
...
public class HbccX509CerGenerator {
    private static final Logger log = LoggerFactory.getLogger(com.hoperun.hbcc.cert.cert.HbccX509CerGenerator.class);
    ...
    public void loadIssuer(String issuerIuputFolder) {
        if (StringUtil.isEmpty(issuerIuputFolder)) {
