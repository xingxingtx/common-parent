package com.wei.arithmetic.encryptdecrypt.factory;

import com.alibaba.fastjson.JSON;
import com.wei.arithmetic.encryptdecrypt.constans.EncryptConstans;
import com.wei.arithmetic.encryptdecrypt.entity.MessageEntity;
import com.wei.arithmetic.encryptdecrypt.type.AESHelper;
import com.wei.arithmetic.encryptdecrypt.type.ECDSAHelper;
import com.wei.arithmetic.encryptdecrypt.type.RSAHelper;
import com.wei.arithmetic.encryptdecrypt.type.SM2Helper;
import com.wei.arithmetic.encryptdecrypt.type.SM4Helper;
import com.wei.arithmetic.encryptdecrypt.type.abs.EncryptAndDecrypt;
...
public class EncryptAndDecryptFactory {
    ...
    public MessageEntity encryptMessageEntity(MessageEntity message, int algorithm, PublicKey publicKey){
        try {
            ...
            log.info("encryptMessageEntity algorithm:{}, type:{}", algorithm, JSON.toJSON(type));
            /**获取加密数据data实例*/
